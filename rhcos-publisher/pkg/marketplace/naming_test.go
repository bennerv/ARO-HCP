...
func TestSKUsForArchX86(t *testing.T) {
	...
	assert.Equal(t, SKU{Name: "aro_4-22_x64_gen2", ImageType: ImageTypeX64Gen2, SecurityTypes: []string{"trusted"}}, skus[0])
}
...
func TestSKUsForArchARM(t *testing.T) {
	...
	require.NoError(t, err)
	require.Len(t, skus, 1)
	assert.Equal(t, SKU{Name: "aro_4-22_arm_gen2", ImageType: ImageTypeARM64Gen2, SecurityTypes: []string{"trusted"}}, skus[0])
}
