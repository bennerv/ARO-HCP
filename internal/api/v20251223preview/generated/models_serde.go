...
func (e ExternalAuthCondition) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.RFC3339](objectMap, "lastTransitionTime", e.LastTransitionTime)
...
func (e *ExternalAuthCondition) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "lastTransitionTime":
			err = unpopulateTime[datetime.RFC3339](val, "LastTransitionTime", &e.LastTransitionTime)
			delete(rawMsg, key)
		case "message":
