...
Single bicep templates can become too big and complex to maintain at times. To mitigate this, we group resources by purpose and move them as dedicated bicep files into the [/dev-infrastructure/modules](../dev-infrastructure/modules) directory.
